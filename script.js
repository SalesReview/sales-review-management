...
const originalDownloadQuotation = window.downloadQuotation;
...
window.downloadQuotation = async function() {
    ...
    await originalDownloadQuotation();
};
...
window.downloadQuotation = window.downloadQuotation || window.originalDownloadQuotation;